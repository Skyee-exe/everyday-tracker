      ...
      <div>
        ...
        <div className="flex flex-col gap-2">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs font-medium text-muted-foreground">You (Online)</span>
          </div>
          {others.map((other, i) => (
            <div key={i} className="flex items-center gap-2">
              <span className="relative w-6 h-6 flex items-center justify-center rounded-full bg-muted text-muted-foreground text-[10px] font-bold">
                <span className="absolute bottom-0 right-0 w-2 h-2 rounded-full bg-emerald-500 border border-background" />
                {other.avatar ? (
              ...
              <span className="text-xs font-medium text-muted-foreground">{other.name}</span>
            </div>
          ))}
        </div>
      </div>
    ...
    <div className="ds-page">
      ...
      <section className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3 mx-7 mt-4 animate-slide-up">
        {statsList.map((stat, i) => {
          ...
          return (
            <div key={i} className="flex items-center justify-between bg-card border border-border rounded-xl p-3.5 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-200">
              <div className="flex items-center gap-2.5 min-w-0">
                ...
                <span className="text-xs font-semibold text-muted-foreground truncate">{stat.label}</span>
              </div>
              <span className="text-base font-bold text-foreground ml-2 shrink-0">{stat.value}</span>
            </div>
          );
        })}
      </section>
        ...
        <div className="ds-focus">
          ...
          {data.focusNow ? (
            ...
            <div className="flex flex-col items-center justify-center text-center gap-3 py-6 text-gray-500 w-full">
              ...
              <p className="text-sm max-w-[320px] leading-relaxed text-muted-foreground">Nothing scheduled right now. Ready to start something new?</p>
              <button className="px-3 py-1.5 border border-border rounded-lg text-xs font-semibold text-muted-foreground hover:bg-muted transition-colors" onClick={() => setActiveModal("task")}>Create task</button>
            </div>
          )}
        </div>
        ...
        <div className="ds-upnext">
          ...
          <div className="ds-upnext-list">
            {data.upNext.length > 0 ? (
              ...
              <span className="block text-center text-xs text-muted-foreground py-3 font-medium">No upcoming deadlines</span>
            )}
          </div>
        </div>
      </section>
      ...
      <section className="flex items-center gap-4 mx-7 p-3.5 bg-card border border-border rounded-xl shadow-sm animate-slide-up">
        <span className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider border-r border-border pr-4 shrink-0">Quick Actions</span>
        <div className="flex items-center gap-2 flex-wrap">
          <button className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-muted border border-border text-muted-foreground text-xs font-semibold hover:bg-indigo-50 hover:border-indigo-100 hover:text-indigo-600 dark:hover:bg-indigo-950/40 dark:hover:border-indigo-900/40 dark:hover:text-indigo-450 hover:-translate-y-0.5 transition-all duration-150 cursor-pointer" onClick={() => setActiveModal("task")}>
            <ListTodo size={13} className="text-rose-500 shrink-0" />
            + Task
          </button>
          <button className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-muted border border-border text-muted-foreground text-xs font-semibold hover:bg-indigo-50 hover:border-indigo-100 hover:text-indigo-600 dark:hover:bg-indigo-950/40 dark:hover:border-indigo-900/40 dark:hover:text-indigo-450 hover:-translate-y-0.5 transition-all duration-150 cursor-pointer" onClick={handleCreateNote}>
            <FileText size={13} className="text-cyan-500 shrink-0" />
            + Note
          </button>
          <button className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-muted border border-border text-muted-foreground text-xs font-semibold hover:bg-indigo-50 hover:border-indigo-100 hover:text-indigo-600 dark:hover:bg-indigo-950/40 dark:hover:border-indigo-900/40 dark:hover:text-indigo-450 hover:-translate-y-0.5 transition-all duration-150 cursor-pointer" onClick={() => setActiveModal("event")}>
          ...
          <button className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-muted border border-border text-muted-foreground text-xs font-semibold hover:bg-indigo-50 hover:border-indigo-100 hover:text-indigo-600 dark:hover:bg-indigo-950/40 dark:hover:border-indigo-900/40 dark:hover:text-indigo-450 hover:-translate-y-0.5 transition-all duration-150 cursor-pointer" onClick={handleCreateWhiteboard}>
            <PenTool size={13} className="text-teal-500 shrink-0" />
            + Whiteboard
          </button>
          <button className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-muted border border-border text-muted-foreground text-xs font-semibold hover:bg-indigo-50 hover:border-indigo-100 hover:text-indigo-600 dark:hover:bg-indigo-950/40 dark:hover:border-indigo-900/40 dark:hover:text-indigo-450 hover:-translate-y-0.5 transition-all duration-150 cursor-pointer" onClick={() => setActiveModal("page")}>
      ...
      <div className="ds-stream animate-slide-up">
          ...
          <div className="ds-section">
            ...
            <div className="ds-task-list">
              {data.inProgressTasks.length > 0 ? (
                ...
                <span className="block text-center text-xs text-muted-foreground py-3.5 font-medium">No active in-progress tasks</span>
              )}
            </div>
          </div>
          ...
          <div className="ds-section">
            ...
            <div className="ds-done-list">
              {data.completedToday.length > 0 ? (
                ...
                <span className="block text-center text-xs text-muted-foreground py-3.5 font-medium">No completed items today yet</span>
              )}
            </div>
          </div>
            ...
            <div className="flex flex-col gap-1.5 mt-1">
              {data.activityList.length > 0 ? (
                data.activityList.map((item, i) => (
                  <div key={i} className="flex items-center gap-2.5 p-2 rounded-lg hover:bg-muted cursor-pointer transition-colors duration-150" onClick={() => router.push(item.href)}>
                    ...
                    <span className="text-[11px] text-muted-foreground font-semibold uppercase tracking-wider shrink-0">{item.action}</span>
                    <span className="text-xs font-semibold text-foreground flex-1 truncate">{item.label}</span>
                    <span className="text-[11px] text-muted-foreground font-medium shrink-0">{item.time}</span>
                  </div>
                ))
              ) : (
                <span className="block text-center text-xs text-muted-foreground py-3.5 font-medium">No recent workspace activity logs</span>
              )}
            </div>
          </div>
        </div>
        ...
        <div className="ds-stream-aside flex flex-col gap-4 bg-card border border-border rounded-xl p-4">
          {/* SCHEDULE */}
          <div>
            <div className="ds-section-head">
            ...
            <div className="ds-schedule">
              {data.todaysSchedule.length > 0 ? (
                ...
                <span className="block text-center text-xs text-muted-foreground py-3.5 font-medium">No calendar items today</span>
              )}
            </div>
          </div>
            ...
            <div className="flex flex-col gap-1.5 mt-1">
              {data.recentNotes.length > 0 ? (
                data.recentNotes.map((n) => (
                  <div key={n.id} className="flex items-center justify-between p-2 rounded-lg hover:bg-muted cursor-pointer transition-colors duration-150" onClick={() => router.push(`/dashboard/notes?noteId=${n.id}`)}>
                    ...
                    <span className="text-[11px] text-muted-foreground font-medium shrink-0 ml-4">{n.updatedAtStr}</span>
                  </div>
                ))
              ) : (
                <span className="block text-center text-xs text-muted-foreground py-3.5 font-medium">No notes created yet</span>
              )}
            </div>
          </div>
            ...
            <div className="flex flex-col gap-1.5 mt-1">
              {data.recentWhiteboards.length > 0 ? (
                data.recentWhiteboards.map((w) => (
                  <div key={w.id} className="flex items-center justify-between p-2 rounded-lg hover:bg-muted cursor-pointer transition-colors duration-150" onClick={() => router.push(`/dashboard/whiteboard?id=${w.id}`)}>
                    <div className="flex items-center gap-2 min-w-0">
                    ...
                    <span className="text-[11px] text-muted-foreground font-medium shrink-0 ml-4">{w.updatedAtStr}</span>
                  </div>
                ))
              ) : (
                <span className="block text-center text-xs text-muted-foreground py-3.5 font-medium">No whiteboards created yet</span>
              )}
            </div>
          </div>
            ...
            <div className="flex flex-col gap-1.5 mt-1">
              {data.recentPages.length > 0 ? (
                data.recentPages.map((p) => (
                  <div key={p.id} className="flex items-center justify-between p-2 rounded-lg hover:bg-muted cursor-pointer transition-colors duration-150" onClick={() => router.push(`/dashboard/pages?spaceId=${p.spaceId}&pageId=${p.id}`)}>
                    <div className="flex items-center gap-2 min-w-0">
                    ...
                    <span className="text-[11px] text-muted-foreground font-medium shrink-0 ml-4">{p.updatedAtStr}</span>
                  </div>
                ))
              ) : (
                <span className="block text-center text-xs text-muted-foreground py-3.5 font-medium">No pages created yet</span>
              )}
            </div>
          </div>
      ...
      <div className="ds-capture-wrap animate-slide-up">
        ...
        {aiResponse && (
          <div className="absolute bottom-14 left-0 right-0 bg-card border border-border rounded-lg p-2.5 shadow-md flex items-center gap-2 text-xs font-semibold text-foreground z-10 animate-fade-in">
            <Sparkles size={12} className="text-indigo-500" />
            <span>{aiResponse}</span>
            <button className="ml-auto p-1 text-gray-400 hover:bg-muted rounded" onClick={() => setAiResponse(null)}>
              <X size={10} />
            </button>
          </div>
        )}
